...
\draw[teal, ->, >=stealth'] (0, 0)--(6,-2)node[black, below, midway, pos=0.5, xshift=0, yshift=-2, scale=0.7] {$\langle 6, -2 \rangle$};

\draw[teal, ->, >=stealth'] (-1,4) -- (5, 2)node[black, above, midway, pos=0.5, xshift=0, yshift=1, scale=0.7]{$\langle 6, -2 \rangle$};

\draw[purple, ->, >=stealth'] (0,0) -- (5, 2)node[black, above, midway, pos=0.4, xshift=0, yshift=2, scale=0.7]{$\langle 5, 2 \rangle$};
