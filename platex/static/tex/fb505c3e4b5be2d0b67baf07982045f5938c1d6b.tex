...
:Tags: polar coordinates;end behavior;polar form of a complex number;area using polar coordinates, polar integral formula ;residual
:Prob: 0.4603;0.4427;0.4425;0.4417;0.4308
:Slug: No name yet
...
\end{tikzpicture}\hskip0.5cm\begin{tikzpicture}[>=latex,xscale=.5*0.65, yscale=.5*0.65][font=\sf\small]
