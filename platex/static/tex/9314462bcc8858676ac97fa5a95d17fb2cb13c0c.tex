...
\draw[teal, ->, >=stealth'] (0, 0)--(-1, 5)node[teal, left, midway, pos=0.5, xshift=0, yshift=-2, scale=0.7] {$\langle -1, 5 \rangle$};

\draw[teal, ->, >=stealth'] (3, -1) -- (2, 4)node[teal, right, midway, pos=0.5, xshift=0, yshift=1, scale=0.7]{$\langle -1, 5 \rangle$};

\draw[purple, ->, >=stealth'] (0,0) -- (2, 4)node[purple, right, midway, pos=0.4, xshift=0, yshift=2, scale=0.7]{$\langle 2, 4 \rangle$};
