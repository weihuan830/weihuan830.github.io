...
:Tags: area using polar coordinates, polar integral formula ;arc length of a curve;moment;end behavior;focus of a parabola
:Prob: 0.3593;0.3549;0.3376;0.3358;0.3295
:Slug: No name yet
...
\draw[cyan, samples=150, smooth, domain=pi/8+7*pi/9:2*pi, variable=\t]
plot ({\t}, {cos(3*\t r)});
